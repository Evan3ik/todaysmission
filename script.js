...
window.onload = function() { // called when page opens
 ...
 //mission count
  ...
  document.getElementById("pastmissionhead").style.display = "none"
  document.getElementById("pastmisions").innerHTML = ""
  if (localStorage.getItem("pastMissions") != null) {
    ...
    if (pastMissions[0].includes(";")) { pastMissions = pastMissions[0].split(";")}
     for(j = 0; j < pastMissions.length; j++) {
       ...
       if (pastMissions[j].length <= 1 || pastMissions[j] == localStorage.getItem("todaysMission")) {continue}
       document.getElementById("pastmissionhead").style.display = "block"
       var pastMission = document.createElement('input')
       pastMission.type = "checkbox"
       pastMission.id = "mission" + j
       pastMission.name = "mission" + j
       var missionLabel = document.createElement('label')
       missionLabel.for = pastMission.id
       missionLabel.textContent = pastMissions[j]
       missionLabel.innerHTML += "<br>";
       document.getElementById("pastmisions").appendChild(pastMission)
       document.getElementById("pastmisions").appendChild(missionLabel)
     }
...
if (localStorage.getItem("missionTime") == null || new Date().getTime() >= parseInt(localStorage.getItem("missionTime")) + 72000000) 
{
document.getElementById("nextday").style.display = "none"
localStorage.setItem("rerolled", "false")
return 
}
//if not - display generated mission
...
var nextTime = parseInt(localStorage.getItem("missionTime")) + 72000000
...
async function generate() {
  ...
  var statusTexts = ["Probing mission database...", "Checking legality...", "Sourcing peanuts...", "Refreshing lighter fluid...", "Buying striped paint...", "Fixing marriages...", "Asking the mission man...", "Shouting out freakbait...", "Blasting nas...", "Cleaning bathrooms...", "Generating information...", "Completing mission...", "Eesting our Software...", "Watching cartoons...", "Speedrunning the missions...", "Fishing for ideas...", "Silencing men...", "Conquering social anxiety...", "Jacking the box...", "Confirming date...", "Stealing 9 Mili...", "Sorting a kilo of missions...", "Missing missions...", "Finding missions...", "Checking if site is online...", "Fixing servers...", "Being nice...", "Refilling on blinker fluid...", "Signaling right...", "Doing 150 on the highway...", "Cranking up the speeds...", "Engaging conversation...", "Grabbing random items...", "Eating mayonnaise...", "Using shampoo..."]
